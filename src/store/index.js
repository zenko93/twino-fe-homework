...
const QUESTION_TO_ANSWER_FIELD_MAP = {
  ...
  "Please indicate the ratio of your regular monthly financial obligations (ex. mortgage repayment) to monthly income": "monthlyFinancial",
  "Your investment strategy": "investmentStrategy",
  "Imagine a situation where a stock market value has fallen by 20% in the last 3 months. At the same time, the value of the shares of a particular company you own has fallen by the same 20%. How would you act?": "marketHasFallen",
  "What is the recommended strategy for allocating/diversifying investment risks?": "diversifyingStrategy",
  "Your education": "education",
  "Your financial experience": "financialExperience",
  "Investment experience in peer-to-peer lending and crowdfunding": "investmentExperience"
}
