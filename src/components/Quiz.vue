  ...
  <div>
    ...
    <div v-for="answer in quiz.answers" :key="answer + quiz.question">
      <div class="flex items-center mb-4">
        ...
        <label
          :for="answer"
          class="flex items-center cursor-pointer text-xl text-blue-900"
        >
          <span
            class="w-6 h-6 min-width inline-block mr-2 rounded-full border border-gray-500 flex-no-shrink"
          />
          {{ answer }}
        </label>
      </div>
    </div>
    <div v-if="noAnswer" class="flex justify-center p-2 border border-red-500">
    ...
    <div class="flex flex-col">
      ...
      <button
        class="underline text-blue-500 focus:outline-none rounded"
